...
const PLATFORM_ALIAS = {
  ...
  nintendo: ['nintendo','switch','switch 2','wii','wii u','wiiu','game boy','gameboy','game boy advance','gameboy advance','game boy color','gameboy color','3ds','nintendo 3ds','nds','nintendo ds','ds','snes','super nintendo','nes','nintendo entertainment system','n64','nintendo 64','gamecube','game cube','virtual boy'],
...
async function getUserDiscoveries(userId) {
  try {
    ...
    const [friends, topThree, booster] = await Promise.all([
