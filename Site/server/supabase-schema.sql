...
ALTER TABLE users ADD COLUMN IF NOT EXISTS psn_npsso TEXT DEFAULT '';
ALTER TABLE users ADD COLUMN IF NOT EXISTS psn_access_token TEXT DEFAULT '';
ALTER TABLE users ADD COLUMN IF NOT EXISTS psn_refresh_token TEXT DEFAULT '';
ALTER TABLE users ADD COLUMN IF NOT EXISTS psn_token_expires_at TIMESTAMPTZ DEFAULT NULL;
...
ALTER TABLE catalog ADD COLUMN IF NOT EXISTS editorial_score TEXT DEFAULT '';
ALTER TABLE catalog ADD COLUMN IF NOT EXISTS user_score TEXT DEFAULT '';
ALTER TABLE catalog ADD COLUMN IF NOT EXISTS platforms_raw TEXT DEFAULT '';
ALTER TABLE catalog ADD COLUMN IF NOT EXISTS jv_url TEXT DEFAULT '';
